...
Module to generate seed in HCP lattice type of spacing in 2D.
...
def hcp_lattice_2D(limit, spacing_length, log_level):
    """
    Generate seeds with HCP lattice type spacing in 2D.

    Processing
    ----------
    The function generates seeds in hcp lattice spacing in 2D and ensures 
    ...
    log.info('Starting to generate HCP 2D type seed spacing')
    ...
    log.info('HCP 2D type seed array was successfully generated')
